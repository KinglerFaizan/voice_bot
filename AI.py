...
st.set_page_config(
    ...
    menu_items={
        ...
        'About': """
            ## ⚠️ MISSION PROTOCOLS (HOW TO USE)

            **1. INITIALIZE:** Click the **'BOOT SYSTEM PROTOCOLS'** button on the start screen to enable audio permissions.

            **2. RECORD:** Click the **'🔴 CLICK TO RECORD'** button to activate the microphone.

            **3. SPEAK:** State your request clearly (e.g., *"I want to book a room"*).

            **4. SEND:** Click the button again **'✅ CLICK TO SEND'** to stop recording and process the command.
