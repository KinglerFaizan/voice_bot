...
st.set_page_config(
    page_title="FRIDAY | PROTOCOL V.2",
    page_icon="⚛️",
    layout="wide",
...
<style>
    ...
    /* MAIN HUD BACKGROUND */
    .stApp {
        background: linear-gradient(rgba(0,0,0,0.7), rgba(10,20,30,0.8)), 
                    url('https://images.unsplash.com/photo-1535868463750-c78d9543614f?q=80&w=2076&auto=format&fit=crop');
    ...
    div[data-testid="metric-container"] {
        ...
        box-shadow: 0 0 10px #00f3ff inset;
        padding: 10px;
        border-radius: 5px;
    }
    label[data-testid="stMetricLabel"] { color: #aaaaaa !important; }
    div[data-testid="stMetricValue"] { color: #ffffff !important; text-shadow: 0 0 10px #00f3ff; }
...
# --- 5. JARVIS VOICE ENGINE ---
def generate_audio_html(text):
    """Generates audio and returns HTML player."""
    try:
...
def process_logic(text):
    ...
    # PHASE 1: GUESTS -> CLASS
        ...
        return "NUMERICAL INPUT REQUIRED."
    ...
    # PHASE 2: CLASS -> VIEW
        ...
        return "CLASS UNAVAILABLE. REPEAT SELECTION."
    ...
    # PHASE 3: VIEW -> NAME
        ...
        return f"{view_sel.upper()} CONFIRMED. STATE NAME FOR RESERVATION."
    ...
    # PHASE 4: NAME -> AUTHORIZE
        ...
        return f"COMPILING: {b['type']} ROOM FOR {b['guests']} GUESTS. DO YOU AUTHORIZE?"
...
if not st.session_state.system_ready:
    ...
    with c2:
        ...
        if st.button("INITIATE SYSTEM BOOT", use_container_width=True):
            ...
            st.session_state.booking_step = 1  # Skip step 0, go straight to guests
            st.rerun()
