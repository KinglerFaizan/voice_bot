...
st.set_page_config(
    page_title="FRIDAY | PROTOCOL V.4",
    page_icon="⚛️",
    layout="wide",
...
if not st.session_state.system_ready:
    ...
    with c2:
        ...
        <div class="instruction-panel">
            ...
            <p class="instruction-text">1. CLICK <b>"INITIATE SYSTEM BOOT"</b> TO ACTIVATE VOICE MODULES.</p>
            <p class="instruction-text">2. CLICK THE <b>ARC REACTOR</b> TO SPEAK.</p>
            <p class="instruction-text">3. CLICK AGAIN TO <b>SEND COMMAND</b>.</p>
        </div>
        """, unsafe_allow_html=True)
        ...
        if st.button("INITIATE SYSTEM BOOT", use_container_width=True):
            ...
            # Set Intro
            intro = "System Online. I am Friday, developed by Faizan. State your command to begin."
